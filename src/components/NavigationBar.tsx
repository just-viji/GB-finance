...
import { Menu, LogOut, Home, PlusCircle, MinusCircle, TrendingUp, User } from 'lucide-react';
        ...
        {isMobile ? (
          <Sheet>
            ...
            <SheetContent side="left" className="w-[250px] sm:w-[300px] bg-background text-foreground">
              <SheetHeader>
                <SheetTitle className="text-primary text-2xl font-bold">GB Finance</SheetTitle>
              </SheetHeader>
              <div className="flex flex-col gap-2 mt-6">
                {navLinks.map((link) => (
                  <Button
                    key={link.name}
                    variant="ghost"
                    className="justify-start text-lg text-foreground hover:bg-accent hover:text-accent-foreground"
